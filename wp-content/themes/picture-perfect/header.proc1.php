...
<div id="imageMenuIcon">
	...
	<a href="<?php echo site_url('hobby'); ?>"  title="Hobby"><img src="<?php echo $url; ?>/img/icon_home.jpg" /></a>
	<a href="<?php echo site_url('video'); ?>"  title="Video"><img src="<?php echo $url; ?>/img/icon_home.jpg" /></a>
	<a href="<?php echo site_url('about-281'); ?>"  title="281 ªü¤@"><img src="<?php echo $url; ?>/img/icon_281sky.png" /></a>
	<a href="<?php echo site_url('address'); ?>"  title="Address"><img src="<?php echo $url; ?>/img/icon_home.jpg" /></a>
</div>
<div id="imageMenu">
<ul>
<!--		
